...
namespace Gloson.Threading.Channels {
  ...
  public static partial class ChannelReaderExtensions {
    ...
    /// <param name="token">Cancellation token</param>
    /// <returns></returns>
    public static ChannelReader<T> Attach<T>(this ChannelReader<T> reader,
    ...
    /// <param name="others">Readers to Merge</param>
    /// <returns></returns>
    public static ChannelReader<T> Attach<T>(this ChannelReader<T> reader, IEnumerable<ChannelReader<T>> others) =>
      Attach(reader, others, default);
