...
namespace Gloson.Collections.Generic {
  ...
  public sealed class DisjointSets<T>
    : IReadOnlyList<IReadOnlyCollection<T>>,
      IEquatable<DisjointSets<T>> {

    #region Internal Classes

    private class OrderedComparerClass : IEqualityComparer<DisjointSets<T>> {
      /// <summary>
      /// Equals 
      /// </summary>
    ...
    /// </summary>
    public DisjointSets(IEqualityComparer<T> itemComparer, int count) {
    ...
    /// Standard constructor
    /// </summary>
    public DisjointSets(IEqualityComparer<T> itemComparer) : this(itemComparer, 0) { }

    /// <summary>
    /// Standard constructor
    /// </summary>
    public DisjointSets(int count) : this(null, count) { }

    /// <summary>
    /// Standard constructor
    /// </summary>
    public DisjointSets() : this(null, 0) { }
    ...
    /// Ordered comparer
    /// </summary>
    public static IEqualityComparer<DisjointSets<T>> OrderedComparer { get; } = new OrderedComparerClass();

    /// <summary>
    /// UnOrdered comparer
    /// </summary>
    public static IEqualityComparer<DisjointSets<T>> UnOrderedComparer { get; } = new UnOrderedComparerClass();
    ...
    /// Equals
    /// </summary>
    public override bool Equals(object o) => Equals(o as DisjointSets<T>);
